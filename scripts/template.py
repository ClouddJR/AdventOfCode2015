...
match input:
    ...
    case "listString":
        ...
        loadResourceMethod = "resourceAsList"
    case "listInt":
        inputType = "List<Int>"
...
f = open(f"../src/main/kotlin/com/clouddjr/advent2015/Day{day}.kt", "w")
fileContent = f'''package com.clouddjr.advent2015
...
f = open(f"../src/test/kotlin/com/clouddjr/advent2015/Day{day}Test.kt", "w")
fileContent = f'''package com.clouddjr.advent2015

import com.clouddjr.advent2015.Resources.{loadResourceMethod}
...
res = requests.get(f"https://adventofcode.com/2015/day/{args.day}/input", cookies={'session': session})
